...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/prod1/project/mlflow/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data")

key = "AIzaSyCCQrf73Febyw39PBO5ZuZTjdPYN3hibc4"
api = Api(api_key=key)
...
with mlflow.start_run():
    for i, id_ in enumerate([x.id.videoId for x in video.items]):
    	...
    	mlflow.log_artifact(local_path="/home/prod1/project/mlops3/scripts/get_data.py",
                        artifact_path="get_data code")
    	mlflow.end_run()

with open('/home/prod1/project/mlops3/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))
